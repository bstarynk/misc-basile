...
int main(int argc, char**argv)
{
  if (argc>1 && !strcmp(argv[1], "--version")) {
    printf("%s: version git %s built on " __DATE__ " at " __TIME__
	    "\n",
	    argv[0], GITID);
    printf("\t see " __FILE__ " source code on https://github.com/bstarynk/misc-basile/\n");
    printf("\t this is a GPLv3+ licensed free software - NO WARRANTY\n");
    printf("\t by Basile Starynkevitch (France)\n");
    printf("\t see license on https://www.gnu.org/licenses/gpl-3.0.html\n");
    exit(EXIT_SUCCESS);
  };
  if (argc>1 && !strcmp(argv[1], "--help")) {
    ...
    printf("\t this is a GPLv3+ licensed free software - NO WARRANTY\n");
    printf("\t by Basile Starynkevitch <basile@starynkevitch.net> (France)\n");
    printf("\t source code on https://github.com/bstarynk/misc-basile/ file " __FILE__ "\n");
    printf("\t see license on https://www.gnu.org/licenses/gpl-3.0.html\n");
