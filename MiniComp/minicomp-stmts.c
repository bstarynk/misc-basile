...
//// this file should contain gccjit statements related code
...
const char minicomp_stmts_gitid[] = GITID;
const char minicomp_stmts_md5sum[] = MD5SUM;
const char minicomp_stmts_timestamp[] = __DATE__ "@" __TIME__;
