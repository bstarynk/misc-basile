...
\begin{frame}\frametitle{Pourquoi j'apprécie Linux}
  ...
  \item Linux est largement utilisé: des tablettes (ou RaspBerryPi) ou
    ...
    dans beaucoup de voitures automobile, la plupart des serveurs Web,
    aux superordinateurs\footnote{Tous les superordinateurs listés sur
    \url{https://top500.org} tournent sous Linux}
...
\begin{frame}\frametitle{Distributions Linux}
  ...
  Beaucoup de distributions GNU/Linux sont facilement téléchargeables
  et redistribuables:
    \begin{itemize}
