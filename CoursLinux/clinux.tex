...
% \clbman{man3/pthread_join.3}{pthread\_join(3)}.
%   
% \smallskip
% Il est nécessaire de synchroniser ces fils par des
% \clburl{//fr.wikipedia.org/wiki/Verrou_(informatique)}{verrous}
%ou des
%\clburl{//fr.wikipedia.org/wiki/Barrière_de_syncrhonisation}{barrières}: 
%\clbman{man3/pthread_mutex_lock.3}{pthread\_lock(3)} et 
%\clbman{man3/pthread_mutex_unlock.3}{pthread\_unlock(3)}
%réalisant une
%\clbhref{https://fr.wikipedia.org/wiki/Exclusion\_mutuelle}{exclusion mutuelle}.
