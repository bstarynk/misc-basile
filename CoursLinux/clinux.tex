...
\begin{frame}\frametitle{espace d'adressage et mémoire virtuelle}
  \begin{tabular}{l|p{5cm}}
    ...
    &
    \raisebox{3.5cm}{
      \parbox{5cm}{ Le noyau gère des segments\footnote{Il y a des milliers de segments pour des centaines de processus. Certaines pages de ces segments sont chargés à la demande (sur interruption) par le noyau.\smallskip\\} de mémoire (code,
...
%%%%
\begin{frame}\frametitle{protocole d'appel système}
  Un appel système transmet entre 0 et 7 arguments fixes (entiers ou
  pointeurs) passés dans des registres. Il peut échouer.
\end{frame}
\end{document}
