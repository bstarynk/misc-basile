...
\begin{frame}\frametitle{interprètes de commande}
  ...
  (\clbhref{https://fr.wikipedia.org/wiki/Shell_Unix}{``shell''}) qui
  lit le terminal ou traite le fichier contenant des commandes.

  \begin{itemize}
  \item standard
    \clbhref{https://pubs.opengroup.org/onlinepubs/9799919799/}{POSIX}
  ...
  \item
    \clbhref{https://fr.wikipedia.org/wiki/Debian_Almquist_shell}{dash}
    est plus rapide.
