...
/* prcsid $Id: genqish.c 1.16 Thu, 23 Dec 2004 13:54:24 +0100 basile $ */
/* prcsproj $ProjectHeader: Qish 1.9 Tue, 28 Dec 2004 12:08:57 +0100 basile $ */
//  Copyright © 2001,2004 Basile STARYNKEVITCH
...
main (int argc, char **argv)
{
  ...
  printf ("#define QISH_SETJMP_SIZE %d /*sizeof(jmp_buf) in bytes*/\n",
	  sizeof (jmp_buf));
  ...
  printf ("/* host: %s */\n", buf);
  printf
    ("/* sizeof int:%d long:%d long long:%d double:%d ptr:%d funptr:%d wchar_t:%d */\n",
...
/* eof $Id: genqish.c 1.16 Thu, 23 Dec 2004 13:54:24 +0100 basile $ */
