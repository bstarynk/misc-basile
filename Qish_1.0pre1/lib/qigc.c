...
/* prcsid $Id: qigc.c 1.44 Tue, 21 Dec 2004 21:56:56 +0100 basile $ */
...
get_fixed_chunk (int sizix)
{
  ...
  qish_dbgprintf ("mmap fixed %p-%p %dK", qishgc_fixed_hi,
	     (char *) qishgc_fixed_hi + allocsz, allocsz >> 10);
...
/* eof $Id: qigc.c 1.44 Tue, 21 Dec 2004 21:56:56 +0100 basile $ */
